 ...
 */
public class SOSImageProvider {
	
	public final static SOSImageProvider INSTANCE = new SOSImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(SOS.resource.SOS.ui.SOSUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				SOS.resource.SOS.ui.SOSUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
