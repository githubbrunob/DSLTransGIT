...
public class ToMPrologDSLTrans implements IObjectActionDelegate {
	private Shell shell;
...
//		System.out.println("filepath: "+filepath);
		...
		final Job job = new Job("Generating MPrologTermReference DSLTrans Serializer model...") {
			...
			protected IStatus run(IProgressMonitor monitor) {
				...
				new mprolog.methods.Methods().transformToMPrologDSLTrans(projectPath, filepath);
