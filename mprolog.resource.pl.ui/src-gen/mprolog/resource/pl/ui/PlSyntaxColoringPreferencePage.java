 ...
 */
public class PlSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public PlSyntaxColoringPreferencePage() {
		super();
		
		mprolog.resource.pl.IPlMetaInformation syntaxPlugin = new mprolog.resource.pl.mopp.PlMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = mprolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mprolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = mprolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mprolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = mprolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mprolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = mprolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mprolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = mprolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mprolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = mprolog.resource.pl.ui.PlSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, mprolog.resource.pl.ui.PlSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		mprolog.resource.pl.ui.PlPixelConverter pixelConverter = new mprolog.resource.pl.ui.PlPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof mprolog.resource.pl.ui.PlEditor) {
			mprolog.resource.pl.ui.PlEditor emfTextEditor = (mprolog.resource.pl.ui.PlEditor) editor;
