 ...
 * @generated
 */
public class MatchModelMatchModelClassCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getMatchModel_Class();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getMatchModelMatchModelClassCompartment_7005SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == AnyMatchClassEditPart.VISUAL_ID
				|| visualID == ExistsMatchClassEditPart.VISUAL_ID
				|| visualID == NegativeMatchClassEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getMatchModelMatchModelClassCompartment_7005SemanticChildren((View) getHost()
						.getModel());
