 ...
 */
public class PlCodeFoldingManager {
	
	private class FoldingUpdateListener implements mprolog.resource.pl.IPlBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(mprolog.resource.pl.ui.PlEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof mprolog.resource.pl.ui.PlEditor) {
				mprolog.resource.pl.ui.PlEditor editor = (mprolog.resource.pl.ui.PlEditor) workbenchPart;
	...
	protected mprolog.resource.pl.ui.PlEditor editor;
	 ...
	 */
	public PlCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,mprolog.resource.pl.ui.PlEditor textEditor) {
	...
	private void addCloseListener(final mprolog.resource.pl.ui.PlEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			mprolog.resource.pl.ui.PlUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		mprolog.resource.pl.IPlTextResource textResource = (mprolog.resource.pl.IPlTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
