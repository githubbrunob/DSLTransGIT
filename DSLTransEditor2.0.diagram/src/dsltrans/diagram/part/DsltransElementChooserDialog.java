 ...
 * @generated
 */
public class DsltransElementChooserDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
				Messages.DsltransElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "dsltrans".equals(fileExtension); //$NON-NLS-1$
	}
