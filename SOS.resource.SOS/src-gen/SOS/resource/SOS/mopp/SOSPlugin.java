 ...
 */
public class SOSPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "SOS.resource.SOS";
	/**
	...
	private static SOSPlugin plugin;
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SOSPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SOSPlugin.PLUGIN_ID, message);
		}
		final SOSPlugin pluginInstance = SOSPlugin.getDefault();
