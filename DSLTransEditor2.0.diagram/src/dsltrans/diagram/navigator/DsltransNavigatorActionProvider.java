...
import dsltrans.diagram.part.DsltransDiagramEditor;
 ...
 * @generated
 */
public class DsltransNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof DsltransNavigatorItem) {
					selectedElement = ((DsltransNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (TransformationModelEditPart.MODEL_ID
							.equals(DsltransVisualIDRegistry
									.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, DsltransDiagramEditor.ID);
