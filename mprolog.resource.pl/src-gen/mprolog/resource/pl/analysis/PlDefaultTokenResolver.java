 ...
 */
public class PlDefaultTokenResolver implements mprolog.resource.pl.IPlTokenResolver {
	 ...
	 */
	public PlDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, mprolog.resource.pl.IPlTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : mprolog.resource.pl.grammar.PlGrammarInformationProvider.INSTANCE.getKeywords()) {
