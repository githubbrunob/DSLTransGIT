 ...
 */
public class SOSLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new SOS.resource.SOS.mopp.SOSMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(SOS.resource.SOS.launch.SOSLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			SOS.resource.SOS.mopp.SOSPlugin.logError("Exception while launching selection", e);
		}
	}
