 ...
 */
public class DsltranstextNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public DsltranstextNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new dsltranstext file");
