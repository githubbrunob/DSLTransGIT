 ...
 */
public class DsltranstextBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final dsltrans.resource.dsltranstext.IDsltranstextTextResource resource, final dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final dsltrans.resource.dsltranstext.IDsltranstextTextResource resource, final dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final dsltrans.resource.dsltranstext.IDsltranstextTextResource resource, final dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
