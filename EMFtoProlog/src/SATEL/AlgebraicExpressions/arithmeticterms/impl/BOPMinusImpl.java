 ...
 * </copyright>
 *
 * $Id: BOPMinusImpl.java,v 1.1 2011/09/27 18:59:53 domingues Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>BOP Minus</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link SATEL.AlgebraicExpressions.arithmeticterms.impl.BOPMinusImpl#getArithmeticTermL <em>Arithmetic Term L</em>}</li>
 *   <li>{@link SATEL.AlgebraicExpressions.arithmeticterms.impl.BOPMinusImpl#getArithmeticTermR <em>Arithmetic Term R</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class BOPMinusImpl extends ArithmeticTermImpl implements BOPMinus {
	/**
	...
	protected EClass eStaticClass() {
		return ArithmetictermsPackage.Literals.BOP_MINUS;
	}
	...
	public NotificationChain basicSetArithmeticTermL(ArithmeticTerm newArithmeticTermL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_L, oldArithmeticTermL, newArithmeticTermL);
	...
	public void setArithmeticTermL(ArithmeticTerm newArithmeticTermL) {
		if (newArithmeticTermL != arithmeticTermL) {
			...
			if (arithmeticTermL != null)
				msgs = ((InternalEObject)arithmeticTermL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_L, null, msgs);
			if (newArithmeticTermL != null)
				msgs = ((InternalEObject)newArithmeticTermL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_L, null, msgs);
			msgs = basicSetArithmeticTermL(newArithmeticTermL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_L, newArithmeticTermL, newArithmeticTermL));
	}
	...
	public NotificationChain basicSetArithmeticTermR(ArithmeticTerm newArithmeticTermR, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_R, oldArithmeticTermR, newArithmeticTermR);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArithmeticTermR(ArithmeticTerm newArithmeticTermR) {
		if (newArithmeticTermR != arithmeticTermR) {
			...
			if (arithmeticTermR != null)
				msgs = ((InternalEObject)arithmeticTermR).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_R, null, msgs);
			if (newArithmeticTermR != null)
				msgs = ((InternalEObject)newArithmeticTermR).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_R, null, msgs);
			msgs = basicSetArithmeticTermR(newArithmeticTermR, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_R, newArithmeticTermR, newArithmeticTermR));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_L:
				return basicSetArithmeticTermL(null, msgs);
			case ArithmetictermsPackage.BOP_MINUS__ARITHMETIC_TERM_R:
