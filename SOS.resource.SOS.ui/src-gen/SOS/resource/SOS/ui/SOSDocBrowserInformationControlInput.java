 ...
 * olInput</code>.
 */
public class SOSDocBrowserInformationControlInput {
	
	private final SOSDocBrowserInformationControlInput fPrevious;
	private SOSDocBrowserInformationControlInput fNext;
	 ...
	 */
	public SOSDocBrowserInformationControlInput(SOSDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public SOSDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public SOSDocBrowserInformationControlInput getNext() {
		return fNext;
	}
