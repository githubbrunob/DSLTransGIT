...
public class DsltranstextPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation().getSyntaxName());
	}
