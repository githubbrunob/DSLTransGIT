...
gendef(false).
op(pre(Xt), #OPRES#) :- 
    once(class('petrinet', 'Transition', Xt, Att_Xt, Rel_Xt)), 
    callReverseList([
    					forall(, (
    								(callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Place', Xp1, Att_Xp1, Rel_Xp1), #OPRES#)])), 
    								(callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'OutArc', Xoutarc, Att_Xoutarc, Rel_Xoutarc), #OPRES#)])), 
    								(callReverseList([equals(#OPRES#, true), op(membergenModel(t, 'outArc', outarc), #OPRES#)])), 
    								(callReverseList([equals(#OPRES#, true), op(membergenModel(outarc, 'sourcePlace', p1), #OPRES#)]))), #OPRES#)]).
op(pos(Xt), #OPRES#) :- 
    once(class('petrinet', 'Transition', Xt, Att_Xt, Rel_Xt)), callReverseList([forall(, ((callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Place', Xp1, Att_Xp1, Rel_Xp1), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'InArc', Xinarc, Att_Xinarc, Rel_Xinarc), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel(t, 'inArc', inarc), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel(inarc, 'targetPlace', p1), #OPRES#)]))), #OPRES#)]).
op(initial, #OPRES#) :- 
    callReverseList([forall(, ((callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Place', Xp1, Att_Xp1, Rel_Xp1), #OPRES#)]))), #OPRES#)]).
opdef(pre).
opdef(pos).
opdef(initial).
gendef(p).
