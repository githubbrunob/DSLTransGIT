 ...
 */
public class PlImageProvider {
	
	public final static PlImageProvider INSTANCE = new PlImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(mprolog.resource.pl.ui.PlUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				mprolog.resource.pl.ui.PlUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
