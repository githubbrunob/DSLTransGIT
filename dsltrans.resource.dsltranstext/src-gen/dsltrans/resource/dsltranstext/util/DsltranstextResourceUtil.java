 ...
 */
public class DsltranstextResourceUtil {
	...
	public static dsltrans.resource.dsltranstext.mopp.DsltranstextResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (dsltrans.resource.dsltranstext.mopp.DsltranstextResource) csResource;
	}
	
	public static dsltrans.resource.dsltranstext.mopp.DsltranstextResource getResource(java.io.File file) {
	...
	public static dsltrans.resource.dsltranstext.mopp.DsltranstextResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (dsltrans.resource.dsltranstext.mopp.DsltranstextResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static dsltrans.TransformationModel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static dsltrans.TransformationModel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (dsltrans.TransformationModel) root;
	}
