...
public class DsltranstextNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private dsltrans.resource.dsltranstext.ui.DsltranstextNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public DsltranstextNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new dsltrans.resource.dsltranstext.ui.DsltranstextNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation().getSyntaxName();
	}
