...
public class PlResourceUtil {
	...
	public static mprolog.resource.pl.mopp.PlResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (mprolog.resource.pl.mopp.PlResource) csResource;
	}
	
	public static mprolog.resource.pl.mopp.PlResource getResource(java.io.File file) {
	...
	public static mprolog.resource.pl.mopp.PlResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new mprolog.resource.pl.mopp.PlMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (mprolog.resource.pl.mopp.PlResource) resource;
	}
	
	/**
	 * Returns the root element of the resource with the given URI.
	 */
	public static mprolog.Model getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static mprolog.Model getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
