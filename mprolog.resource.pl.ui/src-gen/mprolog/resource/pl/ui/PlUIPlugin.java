 ...
 */
public class PlUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "mprolog.resource.pl.ui";
	public static final String EDITOR_ID = "mprolog.resource.pl.ui.PlEditor";
	...
	private static PlUIPlugin plugin;
	...
	public static PlUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, PlUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, PlUIPlugin.PLUGIN_ID, message);
		}
		final PlUIPlugin pluginInstance = PlUIPlugin.getDefault();
