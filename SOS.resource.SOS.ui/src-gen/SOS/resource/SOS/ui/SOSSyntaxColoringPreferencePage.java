 ...
 */
public class SOSSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public SOSSyntaxColoringPreferencePage() {
		super();
		
		SOS.resource.SOS.ISOSMetaInformation syntaxPlugin = new SOS.resource.SOS.mopp.SOSMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = SOS.resource.SOS.ui.SOSSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, SOS.resource.SOS.ui.SOSSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = SOS.resource.SOS.ui.SOSSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, SOS.resource.SOS.ui.SOSSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = SOS.resource.SOS.ui.SOSSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, SOS.resource.SOS.ui.SOSSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = SOS.resource.SOS.ui.SOSSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, SOS.resource.SOS.ui.SOSSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = SOS.resource.SOS.ui.SOSSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, SOS.resource.SOS.ui.SOSSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = SOS.resource.SOS.ui.SOSSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, SOS.resource.SOS.ui.SOSSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		SOS.resource.SOS.ui.SOSPixelConverter pixelConverter = new SOS.resource.SOS.ui.SOSPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof SOS.resource.SOS.ui.SOSEditor) {
			SOS.resource.SOS.ui.SOSEditor emfTextEditor = (SOS.resource.SOS.ui.SOSEditor) editor;
