 ...
 */
public class DsltranstextCodeFoldingManager {
	
	private class FoldingUpdateListener implements dsltrans.resource.dsltranstext.IDsltranstextBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof dsltrans.resource.dsltranstext.ui.DsltranstextEditor) {
				dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor = (dsltrans.resource.dsltranstext.ui.DsltranstextEditor) workbenchPart;
	...
	protected dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor;
	 ...
	 */
	public DsltranstextCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,dsltrans.resource.dsltranstext.ui.DsltranstextEditor textEditor) {
	...
	private void addCloseListener(final dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		dsltrans.resource.dsltranstext.IDsltranstextTextResource textResource = (dsltrans.resource.dsltranstext.IDsltranstextTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
