 ...
 * @generated
 */
public class ExistsMatchClassExistsMatchClassAttributeCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getExistsMatchClassExistsMatchClassAttributeCompartment_7008SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getExistsMatchClassExistsMatchClassAttributeCompartment_7008SemanticChildren((View) getHost()
						.getModel());
