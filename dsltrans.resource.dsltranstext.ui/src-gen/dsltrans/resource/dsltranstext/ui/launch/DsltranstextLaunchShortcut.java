 ...
 */
public class DsltranstextLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(dsltrans.resource.dsltranstext.launch.DsltranstextLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			dsltrans.resource.dsltranstext.mopp.DsltranstextPlugin.logError("Exception while launching selection", e);
		}
	}
