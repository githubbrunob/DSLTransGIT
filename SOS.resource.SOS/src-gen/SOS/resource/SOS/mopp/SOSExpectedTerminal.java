 ...
 */
public class SOSExpectedTerminal {
	
	private int followSetID;
	private SOS.resource.SOS.ISOSExpectedElement terminal;
	...
	public SOSExpectedTerminal(SOS.resource.SOS.ISOSExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public SOS.resource.SOS.ISOSExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((SOSExpectedTerminal) o).terminal);
	}
