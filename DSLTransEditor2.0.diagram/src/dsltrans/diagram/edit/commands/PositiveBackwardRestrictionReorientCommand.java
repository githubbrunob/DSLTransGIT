 ...
 * @generated
 */
public class PositiveBackwardRestrictionReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public PositiveBackwardRestrictionReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof PositiveBackwardRestriction) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPositiveBackwardRestriction_4006(container, getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected PositiveBackwardRestriction getLink() {
		return (PositiveBackwardRestriction) getElementToEdit();
	}
