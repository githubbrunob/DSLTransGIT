 ...
 * </copyright>
 *
 * $Id: ModelImpl.java,v 1.1 2011/08/26 23:25:13 bfb Exp $
 */
package Text.impl;
 ...
 * <ul>
 *   <li>{@link Text.impl.ModelImpl#getDirectory <em>Directory</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends EObjectImpl implements Model {
	...
	protected EClass eStaticClass() {
		return TextPackage.Literals.MODEL;
	}
	...
	public EList<Directory> getDirectory() {
		if (directory == null) {
			directory = new EObjectContainmentEList<Directory>(Directory.class, this, TextPackage.MODEL__DIRECTORY);
		}
		return directory;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TextPackage.MODEL__DIRECTORY:
