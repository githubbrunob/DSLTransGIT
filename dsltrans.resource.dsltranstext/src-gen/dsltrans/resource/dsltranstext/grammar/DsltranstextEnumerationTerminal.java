 ...
 */
public class DsltranstextEnumerationTerminal extends dsltrans.resource.dsltranstext.grammar.DsltranstextTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public DsltranstextEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, dsltrans.resource.dsltranstext.grammar.DsltranstextCardinality cardinality, int mandatoryOccurrencesAfter) {
