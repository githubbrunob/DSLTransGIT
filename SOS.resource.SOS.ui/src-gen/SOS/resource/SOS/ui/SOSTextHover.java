 ...
 */
public class SOSTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private SOS.resource.SOS.ISOSHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final SOS.resource.SOS.ui.SOSBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(SOS.resource.SOS.ui.SOSBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput infoInput = (SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					SOS.resource.SOS.ui.SOSHyperlink hyperlink = new SOS.resource.SOS.ui.SOSHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (SOS.resource.SOS.ui.SOSBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				SOS.resource.SOS.ui.SOSBrowserInformationControl iControl = new SOS.resource.SOS.ui.SOSBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput) {
							SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput input = (SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (SOS.resource.SOS.ui.SOSBrowserInformationControl.isAvailable(parent)) {
				SOS.resource.SOS.ui.SOSBrowserInformationControl iControl = new SOS.resource.SOS.ui.SOSBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public SOSTextHover(SOS.resource.SOS.ISOSResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new SOS.resource.SOS.ui.SOSUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				SOS.resource.SOS.ui.SOSHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			SOS.resource.SOS.ui.SOSHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			SOS.resource.SOS.ui.SOSHTMLPrinter.insertPageProlog(buffer, 0, SOS.resource.SOS.ui.SOSTextHover.getStyleSheet());
			SOS.resource.SOS.ui.SOSHTMLPrinter.addPageEpilog(buffer);
			return new SOS.resource.SOS.ui.SOSDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = SOS.resource.SOS.ui.SOSHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(SOS.resource.SOS.ui.SOSUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return SOS.resource.SOS.util.SOSStreamUtil.getContent(styleSheetURL.openStream());
