 ...
 * 
 */
package mprolog.resource.pl.launch;
...
public class PlLaunchConfigurationHelper {
	...
	public static class SystemOutInterpreter extends mprolog.resource.pl.util.AbstractPlInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, mprolog.resource.pl.util.AbstractPlInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final mprolog.resource.pl.debug.PlDebuggableInterpreter<ResultType, ContextType> interpreter = new mprolog.resource.pl.debug.PlDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		mprolog.resource.pl.debug.PlDebuggerListener<ResultType, ContextType> debugListener = new mprolog.resource.pl.debug.PlDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		mprolog.resource.pl.debug.PlDebugProcess process = new mprolog.resource.pl.debug.PlDebugProcess(launch);
		launch.addDebugTarget(new mprolog.resource.pl.debug.PlDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(mprolog.resource.pl.launch.PlLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return mprolog.resource.pl.util.PlResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, mprolog.resource.pl.mopp.PlPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
