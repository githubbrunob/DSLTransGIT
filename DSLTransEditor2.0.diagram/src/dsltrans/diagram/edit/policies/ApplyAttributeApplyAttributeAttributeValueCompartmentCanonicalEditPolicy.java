 ...
 * @generated
 */
public class ApplyAttributeApplyAttributeAttributeValueCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getApplyAttribute_AttributeValue();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getApplyAttributeApplyAttributeAttributeValueCompartment_7012SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getApplyAttributeApplyAttributeAttributeValueCompartment_7012SemanticChildren((View) getHost()
						.getModel());
