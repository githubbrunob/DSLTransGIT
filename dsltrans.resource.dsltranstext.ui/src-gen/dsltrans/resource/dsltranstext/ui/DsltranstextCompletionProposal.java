 ...
 */
public class DsltranstextCompletionProposal implements java.lang.Comparable<DsltranstextCompletionProposal> {
	...
	public DsltranstextCompletionProposal(String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public DsltranstextCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
		this(insertString, prefix, startsWithPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public DsltranstextCompletionProposal(String insertString, String prefix, boolean startsWithPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image, String displayString) {
	...
	public boolean equals(Object object) {
		if (object instanceof DsltranstextCompletionProposal) {
			DsltranstextCompletionProposal other = (DsltranstextCompletionProposal) object;
	...
	public int compareTo(DsltranstextCompletionProposal object) {
		if (object instanceof DsltranstextCompletionProposal) {
			DsltranstextCompletionProposal other = (DsltranstextCompletionProposal) object;
