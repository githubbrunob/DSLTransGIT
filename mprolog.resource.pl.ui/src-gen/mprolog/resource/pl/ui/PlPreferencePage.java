 ...
 */
public class PlPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(mprolog.resource.pl.ui.PlUIPlugin.getDefault().getPreferenceStore());
		setDescription("Pl Text Editor Preferences");
	}
