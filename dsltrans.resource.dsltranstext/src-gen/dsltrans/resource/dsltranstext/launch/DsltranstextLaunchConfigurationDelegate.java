 ...
 */
public class DsltranstextLaunchConfigurationDelegate extends org.eclipse.debug.core.model.LaunchConfigurationDelegate {
	...
	public void launch(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor) throws org.eclipse.core.runtime.CoreException {
		...
		new dsltrans.resource.dsltranstext.launch.DsltranstextLaunchConfigurationHelper().launch(configuration, mode, launch, monitor);
	}
