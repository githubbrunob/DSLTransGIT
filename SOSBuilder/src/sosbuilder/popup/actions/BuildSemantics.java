...
public class BuildSemantics implements IObjectActionDelegate {
	private Shell shell;
...
//		System.out.println("filepath: "+filepath);
		...
		final Job job = new Job("Compiling prolog from SOS definition...") {
			...
			protected IStatus run(IProgressMonitor monitor) {
				...
				new sosbuilder.Methods().compileToProlog(projectPath, filepath);
				System.setOut(out);
		        System.setErr(err);
