 ...
 */
public class SOSPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(SOS.resource.SOS.ui.SOSUIPlugin.getDefault().getPreferenceStore());
		setDescription("SOS Text Editor Preferences");
	}
