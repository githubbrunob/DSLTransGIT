 ...
 * @generated
 */
public class FilePortFilePortMetaModelIdCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getFilePortFilePortMetaModelIdCompartment_7019SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getFilePortFilePortMetaModelIdCompartment_7019SemanticChildren((View) getHost()
						.getModel());
