 ...
 * @generated
 */
public class ApplyModelApplyModelClassCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getApplyModel_Class();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getApplyModelApplyModelClassCompartment_7010SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ApplyClassEditPart.VISUAL_ID == DsltransVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getApplyModelApplyModelClassCompartment_7010SemanticChildren((View) getHost()
						.getModel());
