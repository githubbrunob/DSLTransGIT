...
public class DsltranstextNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "dsltrans.resource.dsltranstext.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {dsltrans.resource.dsltranstext.mopp.DsltranstextBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(dsltrans.resource.dsltranstext.mopp.DsltranstextBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
