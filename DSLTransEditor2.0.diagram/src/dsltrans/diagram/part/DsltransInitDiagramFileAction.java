 ...
 * @generated
 */
public class DsltransInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new DsltransNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				TransformationModelEditPart.MODEL_ID));
		DsltransDiagramEditorUtil.runWizard(getShell(), wizard,
