 ...
 * </copyright>
 *
 * $Id: AdtmmSwitch.java,v 1.1 2011/09/27 18:59:52 domingues Exp $
 */
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AdtmmPackage.ADT: {
				...
				if (result == null) result = caseEnvironment(adt);
			...
			case AdtmmPackage.SORT: {
				...
				if (result == null) result = caseAbstractSort(sort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case AdtmmPackage.ATOMIC_SORT: {
				...
				if (result == null) result = caseAbstractSort(atomicSort);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
