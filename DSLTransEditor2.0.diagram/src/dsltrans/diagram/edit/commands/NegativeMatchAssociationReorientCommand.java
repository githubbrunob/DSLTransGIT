 ...
 * @generated
 */
public class NegativeMatchAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NegativeMatchAssociationReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof NegativeMatchAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNegativeMatchAssociation_4004(container, getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected NegativeMatchAssociation getLink() {
		return (NegativeMatchAssociation) getElementToEdit();
	}
