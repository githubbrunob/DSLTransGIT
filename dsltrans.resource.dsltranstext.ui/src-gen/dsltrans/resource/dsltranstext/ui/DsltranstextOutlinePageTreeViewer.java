 ...
 * a specified depth.
 */
public class DsltranstextOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public DsltranstextOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof dsltrans.resource.dsltranstext.ui.DsltranstextEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			dsltrans.resource.dsltranstext.mopp.DsltranstextPlugin.logError("Exception while refreshing outline view", e);
		}
	}
