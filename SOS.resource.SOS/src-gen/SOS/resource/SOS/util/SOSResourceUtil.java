...
public class SOSResourceUtil {
	...
	public static SOS.resource.SOS.mopp.SOSResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (SOS.resource.SOS.mopp.SOSResource) csResource;
	}
	
	public static SOS.resource.SOS.mopp.SOSResource getResource(java.io.File file) {
	...
	public static SOS.resource.SOS.mopp.SOSResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new SOS.resource.SOS.mopp.SOSMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (SOS.resource.SOS.mopp.SOSResource) resource;
	}
