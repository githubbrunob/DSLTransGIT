 ...
 * <ul>
 *   <li>{@link Java5.impl.TagElementImpl#getTagName <em>Tag Name</em>}</li>
 *   <li>{@link Java5.impl.TagElementImpl#getFragments <em>Fragments</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TagElementImpl extends ASTNodeImpl implements TagElement {
	...
	protected EClass eStaticClass() {
		return Java5Package.Literals.TAG_ELEMENT;
	}
	...
	public void setTagName(String newTagName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java5Package.TAG_ELEMENT__TAG_NAME, oldTagName, tagName));
	}
	...
	public EList<ASTNode> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentEList<ASTNode>(ASTNode.class, this, Java5Package.TAG_ELEMENT__FRAGMENTS);
		}
		return fragments;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java5Package.TAG_ELEMENT__FRAGMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java5Package.TAG_ELEMENT__TAG_NAME:
				return getTagName();
			case Java5Package.TAG_ELEMENT__FRAGMENTS:
				return getFragments();
		}
