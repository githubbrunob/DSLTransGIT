 ...
 * @generated
 */
public class ConcatConcatRightTermCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatRightTermCompartment_7016SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatRightTermCompartment_7016SemanticChildren((View) getHost()
						.getModel());
