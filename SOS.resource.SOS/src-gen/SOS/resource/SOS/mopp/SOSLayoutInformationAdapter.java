...
/**
 * A SOSLayoutInformationAdapter is used to store layout information that is found
 ...
 * SOSLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class SOSLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<SOS.resource.SOS.mopp.SOSLayoutInformation> layoutInformations = new java.util.ArrayList<SOS.resource.SOS.mopp.SOSLayoutInformation>();
	...
	public java.util.List<SOS.resource.SOS.mopp.SOSLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(SOS.resource.SOS.mopp.SOSLayoutInformation layoutInformation) {
