 ...
 */
public class SOSNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new SOS.resource.SOS.mopp.SOSMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("SOS.resource.SOS.ui");
							...
							String natureID = SOS.resource.SOS.mopp.SOSNature.NATURE_ID;
							...
							for (String builderID : SOS.resource.SOS.mopp.SOSNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								SOS.resource.SOS.mopp.SOSMetaInformation info = new SOS.resource.SOS.mopp.SOSMetaInformation();
