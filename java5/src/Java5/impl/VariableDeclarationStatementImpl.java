 ...
 * <ul>
 *   <li>{@link Java5.impl.VariableDeclarationStatementImpl#getExtraArrayDimensions <em>Extra Array Dimensions</em>}</li>
 *   <li>{@link Java5.impl.VariableDeclarationStatementImpl#getType <em>Type</em>}</li>
 *   <li>{@link Java5.impl.VariableDeclarationStatementImpl#getFragments <em>Fragments</em>}</li>
 *   <li>{@link Java5.impl.VariableDeclarationStatementImpl#getModifiers <em>Modifiers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VariableDeclarationStatementImpl extends StatementImpl implements VariableDeclarationStatement {
	...
	protected EClass eStaticClass() {
		return Java5Package.Literals.VARIABLE_DECLARATION_STATEMENT;
	}
	...
	public void setExtraArrayDimensions(int newExtraArrayDimensions) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java5Package.VARIABLE_DECLARATION_STATEMENT__EXTRA_ARRAY_DIMENSIONS, oldExtraArrayDimensions, extraArrayDimensions));
	}
	...
	public NotificationChain basicSetType(NamedElementRef newType, NotificationChain msgs) {
		...
		type = newType;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Java5Package.VARIABLE_DECLARATION_STATEMENT__TYPE, oldType, newType);
	...
	public void setType(NamedElementRef newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Java5Package.VARIABLE_DECLARATION_STATEMENT__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Java5Package.VARIABLE_DECLARATION_STATEMENT__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java5Package.VARIABLE_DECLARATION_STATEMENT__TYPE, newType, newType));
	}
	...
	public EList<VariableDeclarationFragment> getFragments() {
		if (fragments == null) {
			fragments = new EObjectContainmentWithInverseEList<VariableDeclarationFragment>(VariableDeclarationFragment.class, this, Java5Package.VARIABLE_DECLARATION_STATEMENT__FRAGMENTS, Java5Package.VARIABLE_DECLARATION_FRAGMENT__VARIABLE_DECLARATION_STATEMENT);
		}
		return fragments;
	}
	...
	public EList<Modifier> getModifiers() {
		if (modifiers == null) {
			modifiers = new EObjectContainmentWithInverseEList<Modifier>(Modifier.class, this, Java5Package.VARIABLE_DECLARATION_STATEMENT__MODIFIERS, Java5Package.MODIFIER__VARIABLE_DECLARATION_STATEMENT);
		}
		return modifiers;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java5Package.VARIABLE_DECLARATION_STATEMENT__FRAGMENTS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getFragments()).basicAdd(otherEnd, msgs);
			case Java5Package.VARIABLE_DECLARATION_STATEMENT__MODIFIERS:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Java5Package.VARIABLE_DECLARATION_STATEMENT__TYPE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java5Package.VARIABLE_DECLARATION_STATEMENT__EXTRA_ARRAY_DIMENSIONS:
