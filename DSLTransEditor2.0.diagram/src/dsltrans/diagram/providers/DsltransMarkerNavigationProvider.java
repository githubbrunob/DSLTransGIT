...
import dsltrans.diagram.part.DsltransDiagramEditorUtil;

/**
 * @generated
 */
public class DsltransMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = DsltransDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			DsltransDiagramEditorUtil.selectElementsInDiagram(editor,
