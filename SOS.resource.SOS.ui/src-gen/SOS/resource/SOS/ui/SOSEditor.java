...
/**
 * A text editor for 'SOS' models.
 */
public class SOSEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, SOS.resource.SOS.ISOSResourceProvider, SOS.resource.SOS.ui.ISOSBracketHandlerProvider, SOS.resource.SOS.ui.ISOSAnnotationModelProvider {
	
	private SOS.resource.SOS.ui.SOSHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private SOS.resource.SOS.ui.SOSCodeFoldingManager codeFoldingManager;
	private SOS.resource.SOS.ui.SOSBackgroundParsingStrategy bgParsingStrategy = new SOS.resource.SOS.ui.SOSBackgroundParsingStrategy();
	private java.util.Collection<SOS.resource.SOS.ISOSBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<SOS.resource.SOS.ISOSBackgroundParsingListener>();
	private SOS.resource.SOS.ui.SOSColorManager colorManager = new SOS.resource.SOS.ui.SOSColorManager();
	private SOS.resource.SOS.ui.SOSOutlinePage outlinePage;
	...
	private SOS.resource.SOS.ui.SOSPropertySheetPage propertySheetPage;
	...
	private SOS.resource.SOS.ui.ISOSBracketHandler bracketHandler;
	...
	public SOSEditor() {
		super();
		setSourceViewerConfiguration(new SOS.resource.SOS.ui.SOSEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), SOSEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								SOS.resource.SOS.ISOSTextResource currentResource = getResource();
				...
				SOS.resource.SOS.ui.SOSUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("SOS.resource.SOS.EditorContext");
		setRulerContextMenuId("SOS.resource.SOS.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new SOS.resource.SOS.ui.SOSHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new SOS.resource.SOS.ui.SOSCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		SOS.resource.SOS.mopp.SOSNature.activate(inputFile.getProject());
		...
		SOS.resource.SOS.ISOSTextResource loadedResource = (SOS.resource.SOS.ISOSTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				SOS.resource.SOS.ISOSTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof SOS.resource.SOS.ISOSTextResource) {
					setResource((SOS.resource.SOS.ISOSTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					SOS.resource.SOS.ui.SOSUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the SOSEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				SOS.resource.SOS.ui.SOSUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(SOS.resource.SOS.ISOSTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new SOS.resource.SOS.ui.SOSOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new SOS.resource.SOS.ui.SOSPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			SOS.resource.SOS.ISOSTextResource textResource = (SOS.resource.SOS.ISOSTextResource) element.eResource();
			...
			SOS.resource.SOS.ISOSTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				SOS.resource.SOS.ISOSTextToken token = lexer.getNextToken();
			...
			SOS.resource.SOS.ui.SOSUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!SOSEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(SOS.resource.SOS.ISOSBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (SOS.resource.SOS.ISOSBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public SOS.resource.SOS.ui.ISOSBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(SOS.resource.SOS.ui.ISOSBracketHandler bracketHandler) {
