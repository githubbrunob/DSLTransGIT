 ...
 * @generated
 */
public class PositiveMatchAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PositiveMatchAssociationReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof PositiveMatchAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPositiveMatchAssociation_4003(container, getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected PositiveMatchAssociation getLink() {
		return (PositiveMatchAssociation) getElementToEdit();
	}
