 ...
 * resolver
 */
public interface IPlReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends mprolog.resource.pl.IPlConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, mprolog.resource.pl.IPlReferenceResolveResult<ReferenceType> result);
