 ...
 * @generated
 */
public class AttributeEqualityReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AttributeEqualityReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof AttributeEquality) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttributeEquality_4015(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		Rule container = (Rule) getLink().eContainer();
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistAttributeEquality_4015(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected AttributeEquality getLink() {
		return (AttributeEquality) getElementToEdit();
	}
