 ...
 * @generated
 */
public class ConcatConcatRightTermCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatRightTermCompartment_7014SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatRightTermCompartment_7014SemanticChildren((View) getHost()
						.getModel());
