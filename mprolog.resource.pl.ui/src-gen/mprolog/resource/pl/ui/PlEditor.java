...
/**
 * A text editor for 'pl' models.
 */
public class PlEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, mprolog.resource.pl.IPlResourceProvider, mprolog.resource.pl.ui.IPlBracketHandlerProvider, mprolog.resource.pl.ui.IPlAnnotationModelProvider {
	
	private mprolog.resource.pl.ui.PlHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private mprolog.resource.pl.ui.PlCodeFoldingManager codeFoldingManager;
	private mprolog.resource.pl.ui.PlBackgroundParsingStrategy bgParsingStrategy = new mprolog.resource.pl.ui.PlBackgroundParsingStrategy();
	private java.util.Collection<mprolog.resource.pl.IPlBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<mprolog.resource.pl.IPlBackgroundParsingListener>();
	private mprolog.resource.pl.ui.PlColorManager colorManager = new mprolog.resource.pl.ui.PlColorManager();
	private mprolog.resource.pl.ui.PlOutlinePage outlinePage;
	...
	private mprolog.resource.pl.ui.PlPropertySheetPage propertySheetPage;
	...
	private mprolog.resource.pl.ui.IPlBracketHandler bracketHandler;
	...
	public PlEditor() {
		super();
		setSourceViewerConfiguration(new mprolog.resource.pl.ui.PlEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), PlEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								mprolog.resource.pl.IPlTextResource currentResource = getResource();
				...
				mprolog.resource.pl.ui.PlUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("mprolog.resource.pl.EditorContext");
		setRulerContextMenuId("mprolog.resource.pl.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new mprolog.resource.pl.ui.PlHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new mprolog.resource.pl.ui.PlCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		mprolog.resource.pl.mopp.PlNature.activate(inputFile.getProject());
		...
		mprolog.resource.pl.IPlTextResource loadedResource = (mprolog.resource.pl.IPlTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				mprolog.resource.pl.IPlTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof mprolog.resource.pl.IPlTextResource) {
					setResource((mprolog.resource.pl.IPlTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					mprolog.resource.pl.ui.PlUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the PlEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				mprolog.resource.pl.ui.PlUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(mprolog.resource.pl.IPlTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new mprolog.resource.pl.ui.PlOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new mprolog.resource.pl.ui.PlPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			mprolog.resource.pl.IPlTextResource textResource = (mprolog.resource.pl.IPlTextResource) element.eResource();
			...
			mprolog.resource.pl.IPlTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				mprolog.resource.pl.IPlTextToken token = lexer.getNextToken();
			...
			mprolog.resource.pl.ui.PlUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!PlEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(mprolog.resource.pl.IPlBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (mprolog.resource.pl.IPlBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public mprolog.resource.pl.ui.IPlBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(mprolog.resource.pl.ui.IPlBracketHandler bracketHandler) {
