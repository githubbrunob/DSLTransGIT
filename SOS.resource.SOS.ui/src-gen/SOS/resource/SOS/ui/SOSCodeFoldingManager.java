 ...
 */
public class SOSCodeFoldingManager {
	
	private class FoldingUpdateListener implements SOS.resource.SOS.ISOSBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(SOS.resource.SOS.ui.SOSEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof SOS.resource.SOS.ui.SOSEditor) {
				SOS.resource.SOS.ui.SOSEditor editor = (SOS.resource.SOS.ui.SOSEditor) workbenchPart;
	...
	protected SOS.resource.SOS.ui.SOSEditor editor;
	 ...
	 */
	public SOSCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,SOS.resource.SOS.ui.SOSEditor textEditor) {
	...
	private void addCloseListener(final SOS.resource.SOS.ui.SOSEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			SOS.resource.SOS.ui.SOSUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		SOS.resource.SOS.ISOSTextResource textResource = (SOS.resource.SOS.ISOSTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
