 ...
 * </copyright>
 *
 * $Id: HeadImpl.java,v 1.1 2011/12/28 01:45:32 bfb Exp $
 */
 ...
 * <ul>
 *   <li>{@link mprologTermReference.impl.HeadImpl#getOwnedFunctor <em>Owned Functor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HeadImpl extends EObjectImpl implements Head {
	...
	protected EClass eStaticClass() {
		return MprologTermReferencePackage.Literals.HEAD;
	}
	...
	public NotificationChain basicSetOwnedFunctor(Functor newOwnedFunctor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MprologTermReferencePackage.HEAD__OWNED_FUNCTOR, oldOwnedFunctor, newOwnedFunctor);
	...
	public void setOwnedFunctor(Functor newOwnedFunctor) {
		if (newOwnedFunctor != ownedFunctor) {
			...
			if (ownedFunctor != null)
				msgs = ((InternalEObject)ownedFunctor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MprologTermReferencePackage.HEAD__OWNED_FUNCTOR, null, msgs);
			if (newOwnedFunctor != null)
				msgs = ((InternalEObject)newOwnedFunctor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MprologTermReferencePackage.HEAD__OWNED_FUNCTOR, null, msgs);
			msgs = basicSetOwnedFunctor(newOwnedFunctor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MprologTermReferencePackage.HEAD__OWNED_FUNCTOR, newOwnedFunctor, newOwnedFunctor));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MprologTermReferencePackage.HEAD__OWNED_FUNCTOR:
