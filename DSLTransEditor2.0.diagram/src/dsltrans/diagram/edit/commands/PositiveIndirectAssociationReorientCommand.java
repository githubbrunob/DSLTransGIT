 ...
 * @generated
 */
public class PositiveIndirectAssociationReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public PositiveIndirectAssociationReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof PositiveIndirectAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPositiveIndirectAssociation_4001(container, getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected PositiveIndirectAssociation getLink() {
		return (PositiveIndirectAssociation) getElementToEdit();
	}
