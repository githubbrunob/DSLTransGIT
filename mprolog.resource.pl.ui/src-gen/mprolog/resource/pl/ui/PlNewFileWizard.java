...
public class PlNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private mprolog.resource.pl.ui.PlNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public PlNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new mprolog.resource.pl.ui.PlNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			mprolog.resource.pl.ui.PlUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			mprolog.resource.pl.ui.PlUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new mprolog.resource.pl.mopp.PlMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new mprolog.resource.pl.mopp.PlMetaInformation().getSyntaxName();
	}
	
	public mprolog.resource.pl.IPlMetaInformation getMetaInformation() {
