 ...
 * @generated
 */
public class ApplyAssociationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ApplyAssociationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof ApplyAssociation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistApplyAssociation_4005(container, getLink(),
						getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		ApplyModel container = (ApplyModel) getLink().eContainer();
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistApplyAssociation_4005(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected ApplyAssociation getLink() {
		return (ApplyAssociation) getElementToEdit();
	}
