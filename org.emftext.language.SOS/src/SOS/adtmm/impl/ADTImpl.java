 ...
 * <ul>
 *   <li>{@link SOS.adtmm.impl.ADTImpl#getOwnedSorts <em>Owned Sorts</em>}</li>
 *   <li>{@link SOS.adtmm.impl.ADTImpl#getOwnedOperations <em>Owned Operations</em>}</li>
 *   <li>{@link SOS.adtmm.impl.ADTImpl#getOwnedGenerators <em>Owned Generators</em>}</li>
 *   <li>{@link SOS.adtmm.impl.ADTImpl#getOwnedVariables <em>Owned Variables</em>}</li>
 *   <li>{@link SOS.adtmm.impl.ADTImpl#getOwnedAxioms <em>Owned Axioms</em>}</li>
 *   <li>{@link SOS.adtmm.impl.ADTImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ADTImpl extends EObjectImpl implements ADT {
	/**
