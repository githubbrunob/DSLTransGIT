 ...
 * @generated
 */
public class ApplyClassApplyClassAttributeCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getApplyClass_Attribute();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getApplyClassApplyClassAttributeCompartment_7011SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return ApplyAttributeEditPart.VISUAL_ID == DsltransVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getApplyClassApplyClassAttributeCompartment_7011SemanticChildren((View) getHost()
						.getModel());
