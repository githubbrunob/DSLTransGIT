 ...
 */
public class DsltranstextDefaultTokenResolver implements dsltrans.resource.dsltranstext.IDsltranstextTokenResolver {
	 ...
	 */
	public DsltranstextDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public DsltranstextDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, dsltrans.resource.dsltranstext.IDsltranstextTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : dsltrans.resource.dsltranstext.grammar.DsltranstextGrammarInformationProvider.INSTANCE.getKeywords()) {
