 ...
 */
public class DsltranstextUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "dsltrans.resource.dsltranstext.ui";
	public static final String EDITOR_ID = "dsltrans.resource.dsltranstext.ui.DsltranstextEditor";
	...
	private static DsltranstextUIPlugin plugin;
	
	public DsltranstextUIPlugin() {
		super();
	}
	...
	public static DsltranstextUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, DsltranstextUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, DsltranstextUIPlugin.PLUGIN_ID, message);
		}
		final DsltranstextUIPlugin pluginInstance = DsltranstextUIPlugin.getDefault();
