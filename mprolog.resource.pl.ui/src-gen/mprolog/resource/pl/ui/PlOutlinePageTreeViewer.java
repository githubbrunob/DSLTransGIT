 ...
 * a specified depth.
 */
public class PlOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public PlOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof mprolog.resource.pl.ui.PlEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			mprolog.resource.pl.mopp.PlPlugin.logError("Exception while refreshing outline view", e);
		}
	}
