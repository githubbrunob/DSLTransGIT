...
public class PlExpectedTerminal {
	...
	private mprolog.resource.pl.IPlExpectedElement terminal;
	...
	public PlExpectedTerminal(mprolog.resource.pl.IPlExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public mprolog.resource.pl.IPlExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((PlExpectedTerminal) o).terminal);
	}
