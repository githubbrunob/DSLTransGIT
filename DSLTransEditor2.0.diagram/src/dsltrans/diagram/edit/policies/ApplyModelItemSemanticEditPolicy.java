 ...
 * @generated
 */
public class ApplyModelItemSemanticEditPolicy extends
		DsltransBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ApplyModelItemSemanticEditPolicy() {
					...
					case ApplyClassEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getTargetEdges().iterator(); it
							...
							if (DsltransVisualIDRegistry
									.getVisualID(incomingLink) == ApplyMayBeSameRelationEditPart.VISUAL_ID) {
							...
							if (DsltransVisualIDRegistry
									.getVisualID(incomingLink) == ApplyAssociationEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (DsltransVisualIDRegistry
									.getVisualID(incomingLink) == PositiveBackwardRestrictionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (DsltransVisualIDRegistry
									.getVisualID(incomingLink) == NegativeBackwardRestrictionEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
							...
							if (DsltransVisualIDRegistry
									.getVisualID(incomingLink) == ImportEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										incomingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (DsltransVisualIDRegistry
									.getVisualID(outgoingLink) == ApplyMayBeSameRelationEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
							...
							if (DsltransVisualIDRegistry
									.getVisualID(outgoingLink) == ApplyAssociationEditPart.VISUAL_ID) {
								DestroyElementRequest r = new DestroyElementRequest(
										outgoingLink.getElement(), false);
								cmd.add(new DestroyElementCommand(r));
								cmd.add(new DeleteCommand(getEditingDomain(),
