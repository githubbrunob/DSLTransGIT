 ...
 * resolver
 */
public interface IDsltranstextReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends dsltrans.resource.dsltranstext.IDsltranstextConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, dsltrans.resource.dsltranstext.IDsltranstextReferenceResolveResult<ReferenceType> result);
