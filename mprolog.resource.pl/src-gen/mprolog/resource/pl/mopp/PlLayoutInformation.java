...
/**
 * A PlLayoutInformation is used to store layout information that is found while
...
public class PlLayoutInformation {
	...
	private final mprolog.resource.pl.grammar.PlSyntaxElement syntaxElement;
	...
	public PlLayoutInformation(mprolog.resource.pl.grammar.PlSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public mprolog.resource.pl.grammar.PlSyntaxElement getSyntaxElement() {
