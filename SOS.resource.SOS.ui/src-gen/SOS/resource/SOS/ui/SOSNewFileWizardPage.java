 ...
 */
public class SOSNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public SOSNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new SOS file");
