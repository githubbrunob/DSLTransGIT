 ...
 * </copyright>
 *
 * $Id: ParenthesisImpl.java,v 1.1 2011/12/28 01:45:32 bfb Exp $
 */
 ...
 * <ul>
 *   <li>{@link mprologTermReference.impl.ParenthesisImpl#getOwnedTerm <em>Owned Term</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParenthesisImpl extends TermImpl implements Parenthesis {
	...
	protected EClass eStaticClass() {
		return MprologTermReferencePackage.Literals.PARENTHESIS;
	}
	...
	public NotificationChain basicSetOwnedTerm(Term newOwnedTerm, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, MprologTermReferencePackage.PARENTHESIS__OWNED_TERM, oldOwnedTerm, newOwnedTerm);
	...
	public void setOwnedTerm(Term newOwnedTerm) {
		if (newOwnedTerm != ownedTerm) {
			...
			if (ownedTerm != null)
				msgs = ((InternalEObject)ownedTerm).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - MprologTermReferencePackage.PARENTHESIS__OWNED_TERM, null, msgs);
			if (newOwnedTerm != null)
				msgs = ((InternalEObject)newOwnedTerm).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - MprologTermReferencePackage.PARENTHESIS__OWNED_TERM, null, msgs);
			msgs = basicSetOwnedTerm(newOwnedTerm, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MprologTermReferencePackage.PARENTHESIS__OWNED_TERM, newOwnedTerm, newOwnedTerm));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MprologTermReferencePackage.PARENTHESIS__OWNED_TERM:
