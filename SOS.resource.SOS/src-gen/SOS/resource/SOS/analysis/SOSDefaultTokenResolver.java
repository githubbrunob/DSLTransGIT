 ...
 */
public class SOSDefaultTokenResolver implements SOS.resource.SOS.ISOSTokenResolver {
	 ...
	 */
	public SOSDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public SOSDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, SOS.resource.SOS.ISOSTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : SOS.resource.SOS.grammar.SOSGrammarInformationProvider.INSTANCE.getKeywords()) {
