...
/**
 * A text editor for 'dsltranstext' models.
 */
public class DsltranstextEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, dsltrans.resource.dsltranstext.IDsltranstextResourceProvider, dsltrans.resource.dsltranstext.ui.IDsltranstextBracketHandlerProvider, dsltrans.resource.dsltranstext.ui.IDsltranstextAnnotationModelProvider {
	
	private dsltrans.resource.dsltranstext.ui.DsltranstextHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private dsltrans.resource.dsltranstext.ui.DsltranstextCodeFoldingManager codeFoldingManager;
	private dsltrans.resource.dsltranstext.ui.DsltranstextBackgroundParsingStrategy bgParsingStrategy = new dsltrans.resource.dsltranstext.ui.DsltranstextBackgroundParsingStrategy();
	private java.util.Collection<dsltrans.resource.dsltranstext.IDsltranstextBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<dsltrans.resource.dsltranstext.IDsltranstextBackgroundParsingListener>();
	private dsltrans.resource.dsltranstext.ui.DsltranstextColorManager colorManager = new dsltrans.resource.dsltranstext.ui.DsltranstextColorManager();
	private dsltrans.resource.dsltranstext.ui.DsltranstextOutlinePage outlinePage;
	...
	private dsltrans.resource.dsltranstext.ui.DsltranstextPropertySheetPage propertySheetPage;
	...
	private dsltrans.resource.dsltranstext.ui.IDsltranstextBracketHandler bracketHandler;
	...
	public DsltranstextEditor() {
		super();
		setSourceViewerConfiguration(new dsltrans.resource.dsltranstext.ui.DsltranstextEditorConfiguration(this, this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), DsltranstextEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								dsltrans.resource.dsltranstext.IDsltranstextTextResource currentResource = getResource();
				...
				dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("dsltrans.resource.dsltranstext.EditorContext");
		setRulerContextMenuId("dsltrans.resource.dsltranstext.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new dsltrans.resource.dsltranstext.ui.DsltranstextHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new dsltrans.resource.dsltranstext.ui.DsltranstextCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		dsltrans.resource.dsltranstext.mopp.DsltranstextNature.activate(inputFile.getProject());
		...
		dsltrans.resource.dsltranstext.IDsltranstextTextResource loadedResource = (dsltrans.resource.dsltranstext.IDsltranstextTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				dsltrans.resource.dsltranstext.IDsltranstextTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof dsltrans.resource.dsltranstext.IDsltranstextTextResource) {
					setResource((dsltrans.resource.dsltranstext.IDsltranstextTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the DsltranstextEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(dsltrans.resource.dsltranstext.IDsltranstextTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new dsltrans.resource.dsltranstext.ui.DsltranstextOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new dsltrans.resource.dsltranstext.ui.DsltranstextPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			dsltrans.resource.dsltranstext.IDsltranstextTextResource textResource = (dsltrans.resource.dsltranstext.IDsltranstextTextResource) element.eResource();
			...
			dsltrans.resource.dsltranstext.IDsltranstextTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				dsltrans.resource.dsltranstext.IDsltranstextTextToken token = lexer.getNextToken();
			...
			dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!DsltranstextEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(dsltrans.resource.dsltranstext.IDsltranstextBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (dsltrans.resource.dsltranstext.IDsltranstextBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public dsltrans.resource.dsltranstext.ui.IDsltranstextBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(dsltrans.resource.dsltranstext.ui.IDsltranstextBracketHandler bracketHandler) {
