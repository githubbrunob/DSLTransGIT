...
gendef(false).
op(test(Xt), #OPRES#) :- 
    once(class('petrinet', 'Transition', Xt, Att_Xt, Rel_Xt)), callReverseList([forall((p(zero, zero)), ((callReverseList([equals, op, forall((p(Xp1, Xt)), , #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Place', Xp1, Att_Xp1, Rel_Xp1), #OPRES#)])), callReverseList([])), #OPRES#)]).
op(pre(Xt), #OPRES#) :- 
    once(class('petrinet', 'Transition', Xt, Att_Xt, Rel_Xt)), callReverseList([forall((p(Xp1, #OPRES#)), ((callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Place', Xp1, Att_Xp1, Rel_Xp1), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'OutArc', Xoutarc, Att_Xoutarc, Rel_Xoutarc), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel(Xt, 'outArc', Xoutarc), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel(Xoutarc, 'sourcePlace', Xp1), #OPRES#)])), callReverseList([iter(suc, (zero), (#OPRES#), #OPRES#), op(memberattModel(Xoutarc, 'weight')), #OPRES#])), #OPRES#)]).
op(pos(Xt), #OPRES#) :- 
    once(class('petrinet', 'Transition', Xt, Att_Xt, Rel_Xt)), callReverseList([forall((p(Xp1, #OPRES#)), ((callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Place', Xp1, Att_Xp1, Rel_Xp1), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'InArc', Xinarc, Att_Xinarc, Rel_Xinarc), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel(Xt, 'inArc', Xinarc), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(membergenModel(Xinarc, 'targetPlace', Xp1), #OPRES#)])), callReverseList([iter(suc, (zero), (#OPRES#), #OPRES#), op(memberattModel(Xinarc, 'weight')), #OPRES#])), #OPRES#)]).
op(initial, #OPRES#) :- 
    callReverseList([forall((p(Xp1, #OPRES#)), ((callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Place', Xp1, Att_Xp1, Rel_Xp1), #OPRES#)])), callReverseList([iter(suc, (zero), (#OPRES#), #OPRES#), op(memberattModel(Xp1, 'token')), #OPRES#])), #OPRES#)]).
opdef(test).
opdef(pre).
opdef(pos).
opdef(initial).
...
gendef(e).
gendef(marking).
rule(knowing(#OPRES#), pre([(callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Transition', Xt, Att_Xt, Rel_Xt), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(positive(#OPRES#), #OPRES#), op(subtract(#OPRES#, #OPRES#), #OPRES#), op(build(#OPRES#), #OPRES#), op(pre(Xt), #OPRES#), op(build(#OPRES#), #OPRES#), op(initial, #OPRES#)]))]), pos([(callReverseList([op(build(#OPRES#), #OPRES#), op(initial, #OPRES#)])), (callReverseList([op(buildString(#OPRES#), #OPRES#), op(memberattModel(Xt, 'name')), #OPRES#])), (callReverseList([op(add(#OPRES#, #OPRES#), #OPRES#), op(build(#OPRES#), #OPRES#), op(pos(Xt), #OPRES#), op(subtract(#OPRES#, #OPRES#), #OPRES#), op(build(#OPRES#), #OPRES#), op(pre(Xt), #OPRES#), op(build(#OPRES#), #OPRES#), op(initial, #OPRES#)]))]), know(ts(#OPRES#, #OPRES#, #OPRES#))).
rule(knowing(#OPRES#), pre([(op(membergen(ts(Xoldmarking, XnameX, Xnewmarking), #OPRES#), true)), (callReverseList([equals(#OPRES#, true), op(membergenModel('petrinet', 'Transition', Xt, Att_Xt, Rel_Xt), #OPRES#)])), (callReverseList([equals(#OPRES#, true), op(positive(#OPRES#), #OPRES#), op(subtract(#OPRES#, Xnewmarking), #OPRES#), op(build(#OPRES#), #OPRES#), op(pre(Xt), #OPRES#)]))]), pos([(callReverseList([])), (callReverseList([op(buildString(#OPRES#), #OPRES#), op(memberattModel(Xt, 'name')), #OPRES#])), (callReverseList([op(add(#OPRES#, #OPRES#), #OPRES#), op(build(#OPRES#), #OPRES#), op(pos(Xt), #OPRES#), op(subtract(#OPRES#, Xnewmarking), #OPRES#), op(build(#OPRES#), #OPRES#), op(pre(Xt), #OPRES#)]))]), know(ts(Xnewmarking, #OPRES#, #OPRES#))).
