 ...
 * @generated
 */
public class SequentialSequentialMetaModelIdCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getAbstractSource_MetaModelId();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getSequentialSequentialMetaModelIdCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MetaModelIdentifierEditPart.VISUAL_ID == DsltransVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getSequentialSequentialMetaModelIdCompartment_7001SemanticChildren((View) getHost()
						.getModel());
