 ...
 * resolver
 */
public interface ISOSReferenceResolver<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> extends SOS.resource.SOS.ISOSConfigurable {
	 ...
	 * operation.
	 */
	public void resolve(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int position, boolean resolveFuzzy, SOS.resource.SOS.ISOSReferenceResolveResult<ReferenceType> result);
