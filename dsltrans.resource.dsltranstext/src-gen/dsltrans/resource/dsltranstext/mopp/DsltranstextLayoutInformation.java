...
/**
 * A DsltranstextLayoutInformation is used to store layout information that is
 ...
 * DsltranstextLayoutInformations are aggregated in LayoutInformationAdapters. One
 * DsltranstextLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 */
public class DsltranstextLayoutInformation {
	
	private final dsltrans.resource.dsltranstext.grammar.DsltranstextSyntaxElement syntaxElement;
	...
	public DsltranstextLayoutInformation(dsltrans.resource.dsltranstext.grammar.DsltranstextSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public dsltrans.resource.dsltranstext.grammar.DsltranstextSyntaxElement getSyntaxElement() {
