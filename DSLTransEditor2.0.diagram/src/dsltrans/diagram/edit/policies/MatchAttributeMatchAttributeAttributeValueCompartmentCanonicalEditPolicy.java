 ...
 * @generated
 */
public class MatchAttributeMatchAttributeAttributeValueCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getMatchAttribute_AttributeValue();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getMatchAttributeMatchAttributeAttributeValueCompartment_7007SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == AtomEditPart.VISUAL_ID
				|| visualID == IsNullEditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getMatchAttributeMatchAttributeAttributeValueCompartment_7007SemanticChildren((View) getHost()
						.getModel());
