 ...
 * <ul>
 *   <li>{@link Java5.impl.StringLiteralImpl#getEscapedValue <em>Escaped Value</em>}</li>
 *   <li>{@link Java5.impl.StringLiteralImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringLiteralImpl extends ExpressionImpl implements StringLiteral {
	...
	protected EClass eStaticClass() {
		return Java5Package.Literals.STRING_LITERAL;
	}
	...
	public void setEscapedValue(String newEscapedValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java5Package.STRING_LITERAL__ESCAPED_VALUE, oldEscapedValue, escapedValue));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java5Package.STRING_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java5Package.STRING_LITERAL__ESCAPED_VALUE:
				return getEscapedValue();
			case Java5Package.STRING_LITERAL__VALUE:
				return getValue();
		}
