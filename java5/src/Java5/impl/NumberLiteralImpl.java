 ...
 * <ul>
 *   <li>{@link Java5.impl.NumberLiteralImpl#getTokenValue <em>Token Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumberLiteralImpl extends ExpressionImpl implements NumberLiteral {
	...
	protected EClass eStaticClass() {
		return Java5Package.Literals.NUMBER_LITERAL;
	}
	...
	public void setTokenValue(String newTokenValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Java5Package.NUMBER_LITERAL__TOKEN_VALUE, oldTokenValue, tokenValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Java5Package.NUMBER_LITERAL__TOKEN_VALUE:
