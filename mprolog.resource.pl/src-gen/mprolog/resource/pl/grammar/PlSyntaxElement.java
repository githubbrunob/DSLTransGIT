...
public abstract class PlSyntaxElement {
	...
	private mprolog.resource.pl.grammar.PlCardinality cardinality;
	
	public PlSyntaxElement(mprolog.resource.pl.grammar.PlCardinality cardinality, PlSyntaxElement[] children) {
	...
	public mprolog.resource.pl.grammar.PlCardinality getCardinality() {
		return cardinality;
	}
