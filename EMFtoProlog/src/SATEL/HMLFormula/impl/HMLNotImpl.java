 ...
 * </copyright>
 *
 * $Id: HMLNotImpl.java,v 1.1 2011/09/27 18:59:51 domingues Exp $
 */
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>HML Not</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link SATEL.HMLFormula.impl.HMLNotImpl#getHmlFormulaContent <em>Hml Formula Content</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HMLNotImpl extends HMLFormulaContentImpl implements HMLNot {
	/**
	...
	protected EClass eStaticClass() {
		return HMLFormulaPackage.Literals.HML_NOT;
	}
	...
	public NotificationChain basicSetHmlFormulaContent(HMLFormulaContent newHmlFormulaContent, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, HMLFormulaPackage.HML_NOT__HML_FORMULA_CONTENT, oldHmlFormulaContent, newHmlFormulaContent);
	...
	public void setHmlFormulaContent(HMLFormulaContent newHmlFormulaContent) {
		if (newHmlFormulaContent != hmlFormulaContent) {
			...
			if (hmlFormulaContent != null)
				msgs = ((InternalEObject)hmlFormulaContent).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - HMLFormulaPackage.HML_NOT__HML_FORMULA_CONTENT, null, msgs);
			if (newHmlFormulaContent != null)
				msgs = ((InternalEObject)newHmlFormulaContent).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - HMLFormulaPackage.HML_NOT__HML_FORMULA_CONTENT, null, msgs);
			msgs = basicSetHmlFormulaContent(newHmlFormulaContent, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HMLFormulaPackage.HML_NOT__HML_FORMULA_CONTENT, newHmlFormulaContent, newHmlFormulaContent));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HMLFormulaPackage.HML_NOT__HML_FORMULA_CONTENT:
