 ...
 * @generated
 */
public class ImportReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ImportReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof Import) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistImport_4010(container, getLink(), getNewSource(),
						target);
	}
	...
	protected boolean canReorientTarget() {
		...
		PositiveMatchClass source = getLink().getSource();
		if (!(getLink().eContainer() instanceof Rule)) {
			return false;
		}
		Rule container = (Rule) getLink().eContainer();
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistImport_4010(container, getLink(), source,
						getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected Import getLink() {
		return (Import) getElementToEdit();
	}
