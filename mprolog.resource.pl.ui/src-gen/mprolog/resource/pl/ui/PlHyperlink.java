 ...
 */
public class PlHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public PlHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				mprolog.resource.pl.mopp.PlPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
