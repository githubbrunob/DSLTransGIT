 ...
 * @generated
 */
public class Java5Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Java5Package.ABSTRACT_TYPE_DECLARATION: {
			...
			case Java5Package.ANNOTATION_MEMBER_VALUE_PAIR: {
			...
			case Java5Package.ANNOTATION_TYPE_DECLARATION: {
			...
			case Java5Package.ANNOTATION_TYPE_MEMBER_DECLARATION: {
			...
			case Java5Package.ANONYMOUS_CLASS_DECLARATION: {
			...
			case Java5Package.ARRAY_ACCESS: {
			...
			case Java5Package.ARRAY_CREATION: {
			...
			case Java5Package.ARRAY_INITIALIZER: {
			...
			case Java5Package.ARRAY_LENGTH_ACCESS: {
			...
			case Java5Package.ARRAY_TYPE: {
				ArrayType arrayType = (ArrayType)theEObject;
				T result = caseArrayType(arrayType);
				if (result == null) result = caseOrphanType(arrayType);
				if (result == null) result = caseNamedElement(arrayType);
				if (result == null) result = caseASTNode(arrayType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Java5Package.ASSERT_STATEMENT: {
			...
			case Java5Package.BODY_DECLARATION: {
			...
			case Java5Package.BOOLEAN_LITERAL: {
			...
			case Java5Package.BREAK_STATEMENT: {
			...
			case Java5Package.CAST_EXPRESSION: {
			...
			case Java5Package.CATCH_CLAUSE: {
			...
			case Java5Package.CHARACTER_LITERAL: {
			...
			case Java5Package.CLASS_DECLARATION: {
			...
			case Java5Package.CLASS_INSTANCE_CREATION: {
			...
			case Java5Package.COMPILATION_UNIT: {
			...
			case Java5Package.CONDITIONAL_EXPRESSION: {
			...
			case Java5Package.CONSTRUCTOR_INVOCATION: {
			...
			case Java5Package.CONTINUE_STATEMENT: {
			...
			case Java5Package.DO_STATEMENT: {
			...
			case Java5Package.EMPTY_STATEMENT: {
			...
			case Java5Package.ENUM_DECLARATION: {
			...
			case Java5Package.ENUM_CONSTANT_DECLARATION: {
			...
			case Java5Package.ENHANCED_FOR_STATEMENT: {
			...
			case Java5Package.EXPRESSION_STATEMENT: {
			...
			case Java5Package.FIELD_ACCESS: {
			...
			case Java5Package.FIELD_DECLARATION: {
			...
			case Java5Package.FOR_STATEMENT: {
			...
			case Java5Package.IF_STATEMENT: {
			...
			case Java5Package.IMPORT_DECLARATION: {
			...
			case Java5Package.INFIX_EXPRESSION: {
			...
			case Java5Package.INSTANCEOF_EXPRESSION: {
			...
			case Java5Package.INTERFACE_DECLARATION: {
			...
			case Java5Package.LABELED_STATEMENT: {
			...
			case Java5Package.METHOD_DECLARATION: {
			...
			case Java5Package.METHOD_INVOCATION: {
			...
			case Java5Package.METHOD_REF_PARAMETER: {
			...
			case Java5Package.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Java5Package.MODIFIER: {
			...
			case Java5Package.NAMED_ELEMENT: {
			...
			case Java5Package.NAMED_ELEMENT_REF: {
				...
				if (result == null) result = caseASTNode(namedElementRef);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Java5Package.NULL_LITERAL: {
			...
			case Java5Package.NUMBER_LITERAL: {
			...
			case Java5Package.ORPHAN_TYPE: {
				OrphanType orphanType = (OrphanType)theEObject;
				T result = caseOrphanType(orphanType);
				if (result == null) result = caseNamedElement(orphanType);
				if (result == null) result = caseASTNode(orphanType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Java5Package.PACKAGE_DECLARATION: {
			...
			case Java5Package.POSTFIX_EXPRESSION: {
			...
			case Java5Package.PREFIX_EXPRESSION: {
			...
			case Java5Package.PRIMITIVE_TYPE: {
				PrimitiveType primitiveType = (PrimitiveType)theEObject;
				T result = casePrimitiveType(primitiveType);
				if (result == null) result = caseOrphanType(primitiveType);
				if (result == null) result = caseNamedElement(primitiveType);
				if (result == null) result = caseASTNode(primitiveType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Java5Package.PRIMITIVE_TYPE_BOOLEAN: {
			...
			case Java5Package.SINGLE_VARIABLE_DECLARATION: {
			...
			case Java5Package.STRING_LITERAL: {
			...
			case Java5Package.SUPER_CONSTRUCTOR_INVOCATION: {
			...
			case Java5Package.SUPER_FIELD_ACCESS: {
			...
			case Java5Package.SUPER_METHOD_INVOCATION: {
			...
			case Java5Package.SWITCH_STATEMENT: {
			...
			case Java5Package.SYNCHRONIZED_STATEMENT: {
			...
			case Java5Package.TEXT_ELEMENT: {
			...
			case Java5Package.THIS_EXPRESSION: {
			...
			case Java5Package.THROW_STATEMENT: {
			...
			case Java5Package.TYPE_DECLARATION: {
			...
			case Java5Package.TYPE_DECLARATION_STATEMENT: {
			...
			case Java5Package.TYPE_LITERAL: {
			...
			case Java5Package.TYPE_PARAMETER: {
			...
			case Java5Package.TRY_STATEMENT: {
			...
			case Java5Package.UNRESOLVED_ITEM: {
			...
			case Java5Package.VARIABLE_DECLARATION: {
			...
			case Java5Package.VARIABLE_DECLARATION_EXPRESSION: {
			...
			case Java5Package.VARIABLE_DECLARATION_FRAGMENT: {
			...
			case Java5Package.VARIABLE_DECLARATION_STATEMENT: {
			...
			case Java5Package.WHILE_STATEMENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Orphan Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Orphan Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOrphanType(OrphanType object) {
		return null;
	}
