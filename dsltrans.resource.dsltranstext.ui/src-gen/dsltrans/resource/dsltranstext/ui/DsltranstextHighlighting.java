 ...
 */
public class DsltranstextHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	
	private final static dsltrans.resource.dsltranstext.ui.DsltranstextPositionHelper positionHelper = new dsltrans.resource.dsltranstext.ui.DsltranstextPositionHelper();
	...
	private dsltrans.resource.dsltranstext.ui.DsltranstextTokenScanner scanner;
	...
	private dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private dsltrans.resource.dsltranstext.ui.DsltranstextOccurrence occurrence;
	private dsltrans.resource.dsltranstext.ui.DsltranstextBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, dsltrans.resource.dsltranstext.IDsltranstextBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public DsltranstextHighlighting(dsltrans.resource.dsltranstext.IDsltranstextTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, dsltrans.resource.dsltranstext.ui.DsltranstextColorManager colorManager, dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new dsltrans.resource.dsltranstext.ui.DsltranstextTokenScanner(textResource, colorManager);
		occurrence = new dsltrans.resource.dsltranstext.ui.DsltranstextOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new dsltrans.resource.dsltranstext.ui.DsltranstextBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(dsltrans.resource.dsltranstext.ui.DsltranstextPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, dsltrans.resource.dsltranstext.ui.DsltranstextPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, dsltrans.resource.dsltranstext.ui.DsltranstextPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, dsltrans.resource.dsltranstext.ui.DsltranstextPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(dsltrans.resource.dsltranstext.ui.DsltranstextPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new dsltrans.resource.dsltranstext.ui.DsltranstextEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
