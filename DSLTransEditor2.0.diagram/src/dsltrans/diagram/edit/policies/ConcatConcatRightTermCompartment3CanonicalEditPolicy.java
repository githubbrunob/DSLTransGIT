 ...
 * @generated
 */
public class ConcatConcatRightTermCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getConcat_RightTerm();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatRightTermCompartment_7018SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatRightTermCompartment_7018SemanticChildren((View) getHost()
						.getModel());
