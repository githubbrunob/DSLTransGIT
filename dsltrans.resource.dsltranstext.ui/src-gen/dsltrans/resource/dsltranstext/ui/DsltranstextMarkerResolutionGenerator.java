...
public class DsltranstextMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(dsltrans.resource.dsltranstext.IDsltranstextOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof dsltrans.resource.dsltranstext.mopp.DsltranstextResource) {
					dsltrans.resource.dsltranstext.mopp.DsltranstextResource customResource = (dsltrans.resource.dsltranstext.mopp.DsltranstextResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<dsltrans.resource.dsltranstext.IDsltranstextQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final dsltrans.resource.dsltranstext.IDsltranstextQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<dsltrans.resource.dsltranstext.IDsltranstextQuickFix> getQuickFixes(dsltrans.resource.dsltranstext.IDsltranstextTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					dsltrans.resource.dsltranstext.IDsltranstextQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
