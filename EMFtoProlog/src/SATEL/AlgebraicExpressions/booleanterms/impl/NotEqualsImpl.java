 ...
 * </copyright>
 *
 * $Id: NotEqualsImpl.java,v 1.1 2011/09/27 18:59:52 domingues Exp $
 */
 ...
 * <ul>
 *   <li>{@link SATEL.AlgebraicExpressions.booleanterms.impl.NotEqualsImpl#getArithmeticTermR <em>Arithmetic Term R</em>}</li>
 *   <li>{@link SATEL.AlgebraicExpressions.booleanterms.impl.NotEqualsImpl#getArithmeticTermL <em>Arithmetic Term L</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NotEqualsImpl extends BooleanTermImpl implements NotEquals {
	/**
	...
	protected EClass eStaticClass() {
		return BooleantermsPackage.Literals.NOT_EQUALS;
	}
	...
	public NotificationChain basicSetArithmeticTermR(ArithmeticTerm newArithmeticTermR, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_R, oldArithmeticTermR, newArithmeticTermR);
	...
	public void setArithmeticTermR(ArithmeticTerm newArithmeticTermR) {
		if (newArithmeticTermR != arithmeticTermR) {
			...
			if (arithmeticTermR != null)
				msgs = ((InternalEObject)arithmeticTermR).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_R, null, msgs);
			if (newArithmeticTermR != null)
				msgs = ((InternalEObject)newArithmeticTermR).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_R, null, msgs);
			msgs = basicSetArithmeticTermR(newArithmeticTermR, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_R, newArithmeticTermR, newArithmeticTermR));
	}
	...
	public NotificationChain basicSetArithmeticTermL(ArithmeticTerm newArithmeticTermL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_L, oldArithmeticTermL, newArithmeticTermL);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setArithmeticTermL(ArithmeticTerm newArithmeticTermL) {
		if (newArithmeticTermL != arithmeticTermL) {
			...
			if (arithmeticTermL != null)
				msgs = ((InternalEObject)arithmeticTermL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_L, null, msgs);
			if (newArithmeticTermL != null)
				msgs = ((InternalEObject)newArithmeticTermL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_L, null, msgs);
			msgs = basicSetArithmeticTermL(newArithmeticTermL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_L, newArithmeticTermL, newArithmeticTermL));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_R:
				return basicSetArithmeticTermR(null, msgs);
			case BooleantermsPackage.NOT_EQUALS__ARITHMETIC_TERM_L:
