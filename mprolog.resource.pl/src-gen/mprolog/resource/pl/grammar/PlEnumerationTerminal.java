 ...
 */
public class PlEnumerationTerminal extends mprolog.resource.pl.grammar.PlTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public PlEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, mprolog.resource.pl.grammar.PlCardinality cardinality, int mandatoryOccurrencesAfter) {
