 ...
 * 
 */
package dsltrans.resource.dsltranstext.launch;

/**
 * A class that provides common methods that are required by launch configuration
 * delegates.
 */
public class DsltranstextLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends dsltrans.resource.dsltranstext.util.AbstractDsltranstextInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, dsltrans.resource.dsltranstext.util.AbstractDsltranstextInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final dsltrans.resource.dsltranstext.debug.DsltranstextDebuggableInterpreter<ResultType, ContextType> interpreter = new dsltrans.resource.dsltranstext.debug.DsltranstextDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		dsltrans.resource.dsltranstext.debug.DsltranstextDebuggerListener<ResultType, ContextType> debugListener = new dsltrans.resource.dsltranstext.debug.DsltranstextDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		dsltrans.resource.dsltranstext.debug.DsltranstextDebugProcess process = new dsltrans.resource.dsltranstext.debug.DsltranstextDebugProcess(launch);
		launch.addDebugTarget(new dsltrans.resource.dsltranstext.debug.DsltranstextDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(dsltrans.resource.dsltranstext.launch.DsltranstextLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return dsltrans.resource.dsltranstext.util.DsltranstextResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, dsltrans.resource.dsltranstext.mopp.DsltranstextPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
