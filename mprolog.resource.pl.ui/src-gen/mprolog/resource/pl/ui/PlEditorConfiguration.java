 ...
 */
public class PlEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private mprolog.resource.pl.ui.PlQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public PlEditorConfiguration(mprolog.resource.pl.IPlResourceProvider resourceProvider, mprolog.resource.pl.ui.IPlAnnotationModelProvider annotationModelProvider, mprolog.resource.pl.ui.IPlBracketHandlerProvider bracketHandlerProvider, mprolog.resource.pl.ui.PlColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new mprolog.resource.pl.ui.PlCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new mprolog.resource.pl.ui.PlTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new mprolog.resource.pl.ui.PlTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new mprolog.resource.pl.ui.PlHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new mprolog.resource.pl.ui.PlQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
