 ...
 */
public class SOSHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public SOSHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				SOS.resource.SOS.mopp.SOSPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
