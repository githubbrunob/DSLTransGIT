 ...
 */
public class SOSUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "SOS.resource.SOS.ui";
	public static final String EDITOR_ID = "SOS.resource.SOS.ui.SOSEditor";
	...
	private static SOSUIPlugin plugin;
	...
	public static SOSUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SOSUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SOSUIPlugin.PLUGIN_ID, message);
		}
		final SOSUIPlugin pluginInstance = SOSUIPlugin.getDefault();
