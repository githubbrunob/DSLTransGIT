 ...
 */
public class DsltranstextBracketSet {
	...
	private java.util.ArrayList<dsltrans.resource.dsltranstext.IDsltranstextBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements dsltrans.resource.dsltranstext.IDsltranstextBracketPair {
	 ...
	 */
	private class ClosingListener implements dsltrans.resource.dsltranstext.ui.IDsltranstextBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				dsltrans.resource.dsltranstext.IDsltranstextBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public DsltranstextBracketSet(dsltrans.resource.dsltranstext.ui.DsltranstextEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<dsltrans.resource.dsltranstext.IDsltranstextBracketPair>();
	 ...
	 */
	public dsltrans.resource.dsltranstext.IDsltranstextBracketPair getBracketPair(String opening, String closing) {
		for (dsltrans.resource.dsltranstext.IDsltranstextBracketPair bracketPair : bracketPairs) {
	...
	public dsltrans.resource.dsltranstext.IDsltranstextBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(dsltrans.resource.dsltranstext.IDsltranstextBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + dsltrans.resource.dsltranstext.ui.DsltranstextPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public dsltrans.resource.dsltranstext.IDsltranstextBracketPair remove(String opening, String closing) {
		for (dsltrans.resource.dsltranstext.IDsltranstextBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<dsltrans.resource.dsltranstext.IDsltranstextBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, dsltrans.resource.dsltranstext.ui.DsltranstextPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, dsltrans.resource.dsltranstext.ui.DsltranstextPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}
