...
/**
 * This is the item provider adapter for a {@link dsltrans.Association} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Association_associationName_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Association_associationName_feature", "_UI_Association_type"),
         DsltransPackage.Literals.ASSOCIATION__ASSOCIATION_NAME,
         true,
         false,
         false,
  ...
  {
    String label = ((Association)object).getAssociationName();
