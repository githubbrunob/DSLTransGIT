 ...
 * </copyright>
 *
 * $Id: TextSwitch.java,v 1.1 2011/08/26 23:25:13 bfb Exp $
 */
package Text.util;
...
public class TextSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TextPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TextPackage.DIRECTORY: {
			...
			case TextPackage.CONTENT: {
				Content content = (Content)theEObject;
				T result = caseContent(content);
				if (result == null) result = caseLine(content);
				if (result == null) result = caseNamedElement(content);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TextPackage.EMPTY_LINE: {
				EmptyLine emptyLine = (EmptyLine)theEObject;
				T result = caseEmptyLine(emptyLine);
				if (result == null) result = caseLine(emptyLine);
				if (result == null) result = caseNamedElement(emptyLine);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
