 ...
 */
public class PlBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final mprolog.resource.pl.IPlTextResource resource, final mprolog.resource.pl.ui.PlEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final mprolog.resource.pl.IPlTextResource resource, final mprolog.resource.pl.ui.PlEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final mprolog.resource.pl.IPlTextResource resource, final mprolog.resource.pl.ui.PlEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
