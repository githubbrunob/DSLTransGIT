 ...
 */
public class DsltranstextSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public DsltranstextSyntaxColoringPreferencePage() {
		super();
		
		dsltrans.resource.dsltranstext.IDsltranstextMetaInformation syntaxPlugin = new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dsltrans.resource.dsltranstext.ui.DsltranstextSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		dsltrans.resource.dsltranstext.ui.DsltranstextPixelConverter pixelConverter = new dsltrans.resource.dsltranstext.ui.DsltranstextPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof dsltrans.resource.dsltranstext.ui.DsltranstextEditor) {
			dsltrans.resource.dsltranstext.ui.DsltranstextEditor emfTextEditor = (dsltrans.resource.dsltranstext.ui.DsltranstextEditor) editor;
