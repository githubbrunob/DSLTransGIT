...
public class SOSTextToken implements SOS.resource.SOS.ISOSTextToken {
	
	private final SOS.resource.SOS.ISOSMetaInformation metaInformation = new SOS.resource.SOS.mopp.SOSMetaInformation();
	private final org.antlr.runtime3_3_0.Token antlrToken;
	
	public SOSTextToken(org.antlr.runtime3_3_0.Token antlrToken) {
		super();
