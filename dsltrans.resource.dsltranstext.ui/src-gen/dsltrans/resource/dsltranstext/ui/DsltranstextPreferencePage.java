 ...
 */
public class DsltranstextPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	public void init(org.eclipse.ui.IWorkbench workbench) {
		setPreferenceStore(dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.getDefault().getPreferenceStore());
		setDescription("Dsltranstext Text Editor Preferences");
	}
