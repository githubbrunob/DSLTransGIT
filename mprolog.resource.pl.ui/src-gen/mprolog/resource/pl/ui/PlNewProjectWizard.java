 ...
 */
public class PlNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new mprolog.resource.pl.mopp.PlMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("mprolog.resource.pl.ui");
							...
							String natureID = mprolog.resource.pl.mopp.PlNature.NATURE_ID;
							...
							for (String builderID : mprolog.resource.pl.mopp.PlNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								mprolog.resource.pl.mopp.PlMetaInformation info = new mprolog.resource.pl.mopp.PlMetaInformation();
