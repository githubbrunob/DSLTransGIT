 ...
 * @generated
 */
public class ConcatConcatLeftTermCompartment3CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getConcat_LeftTerm();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatLeftTermCompartment_7017SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatLeftTermCompartment_7017SemanticChildren((View) getHost()
						.getModel());
