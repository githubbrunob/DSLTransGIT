 ...
 * @since 3.2
 */
public class DsltranstextBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private dsltrans.resource.dsltranstext.ui.DsltranstextDocBrowserInformationControlInput fInput;
	 ...
	 */
	public DsltranstextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public DsltranstextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public DsltranstextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof dsltrans.resource.dsltranstext.ui.DsltranstextDocBrowserInformationControlInput);
		...
		fInput= (dsltrans.resource.dsltranstext.ui.DsltranstextDocBrowserInformationControlInput) input;
		...
		dsltrans.resource.dsltranstext.ui.DsltranstextHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = dsltrans.resource.dsltranstext.ui.DsltranstextHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public dsltrans.resource.dsltranstext.ui.DsltranstextDocBrowserInformationControlInput getInput() {
		return fInput;
	}
