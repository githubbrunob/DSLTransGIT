 ...
 */
public class DsltranstextPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "dsltrans.resource.dsltranstext";
	/**
	...
	private static DsltranstextPlugin plugin;
	
	public DsltranstextPlugin() {
		super();
	}
	...
	public static DsltranstextPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, DsltranstextPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, DsltranstextPlugin.PLUGIN_ID, message);
		}
		final DsltranstextPlugin pluginInstance = DsltranstextPlugin.getDefault();
