 ...
 * olInput</code>.
 */
public class PlDocBrowserInformationControlInput {
	
	private final PlDocBrowserInformationControlInput fPrevious;
	private PlDocBrowserInformationControlInput fNext;
	 ...
	 */
	public PlDocBrowserInformationControlInput(PlDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public PlDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public PlDocBrowserInformationControlInput getNext() {
		return fNext;
	}
