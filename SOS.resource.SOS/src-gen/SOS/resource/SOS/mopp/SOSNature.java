...
public class SOSNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "SOS.resource.SOS.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {SOS.resource.SOS.mopp.SOSBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(SOS.resource.SOS.mopp.SOSBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
