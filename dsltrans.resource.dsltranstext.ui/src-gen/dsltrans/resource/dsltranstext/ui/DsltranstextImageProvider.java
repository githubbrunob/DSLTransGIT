 ...
 */
public class DsltranstextImageProvider {
	
	public final static DsltranstextImageProvider INSTANCE = new DsltranstextImageProvider();
	...
	public org.eclipse.swt.graphics.Image getImage(String key) {
		...
		org.eclipse.jface.resource.ImageDescriptor descriptor = org.eclipse.jface.resource.ImageDescriptor.createFromURL(org.eclipse.core.runtime.FileLocator.find(dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.getDefault().getBundle(), path, null));
		if (org.eclipse.jface.resource.ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				dsltrans.resource.dsltranstext.ui.DsltranstextUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
