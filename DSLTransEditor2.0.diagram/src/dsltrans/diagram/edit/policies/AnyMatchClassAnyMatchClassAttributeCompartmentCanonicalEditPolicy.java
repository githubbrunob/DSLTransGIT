 ...
 * @generated
 */
public class AnyMatchClassAnyMatchClassAttributeCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getAnyMatchClassAnyMatchClassAttributeCompartment_7006SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getAnyMatchClassAnyMatchClassAttributeCompartment_7006SemanticChildren((View) getHost()
						.getModel());
