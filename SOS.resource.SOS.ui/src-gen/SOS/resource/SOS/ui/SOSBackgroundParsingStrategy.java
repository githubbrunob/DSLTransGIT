 ...
 */
public class SOSBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final SOS.resource.SOS.ISOSTextResource resource, final SOS.resource.SOS.ui.SOSEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final SOS.resource.SOS.ISOSTextResource resource, final SOS.resource.SOS.ui.SOSEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final SOS.resource.SOS.ISOSTextResource resource, final SOS.resource.SOS.ui.SOSEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
