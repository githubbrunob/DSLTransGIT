 ...
 * a specified depth.
 */
public class SOSOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	
	boolean suppressNotifications = false;
	
	public SOSOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
	}
	
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof SOS.resource.SOS.ui.SOSEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			SOS.resource.SOS.mopp.SOSPlugin.logError("Exception while refreshing outline view", e);
		}
	}
