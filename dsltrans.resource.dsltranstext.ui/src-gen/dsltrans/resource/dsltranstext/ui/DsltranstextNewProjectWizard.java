 ...
 */
public class DsltranstextNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation().getSyntaxName() + " Project";
	 ...
	 * The constructor.
	 */
	public DsltranstextNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("dsltrans.resource.dsltranstext.ui");
							...
							String natureID = dsltrans.resource.dsltranstext.mopp.DsltranstextNature.NATURE_ID;
							...
							for (String builderID : dsltrans.resource.dsltranstext.mopp.DsltranstextNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation info = new dsltrans.resource.dsltranstext.mopp.DsltranstextMetaInformation();
