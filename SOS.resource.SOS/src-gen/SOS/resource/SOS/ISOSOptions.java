...
public interface ISOSOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new SOS.resource.SOS.mopp.SOSMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new SOS.resource.SOS.mopp.SOSMetaInformation().getResourcePostProcessorProviderOptionKey();
