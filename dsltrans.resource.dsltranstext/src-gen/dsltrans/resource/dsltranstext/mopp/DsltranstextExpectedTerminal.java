 ...
 */
public class DsltranstextExpectedTerminal {
	
	private int followSetID;
	private dsltrans.resource.dsltranstext.IDsltranstextExpectedElement terminal;
	...
	public DsltranstextExpectedTerminal(dsltrans.resource.dsltranstext.IDsltranstextExpectedElement terminal, int followSetID, org.eclipse.emf.ecore.EStructuralFeature... containmentTrace) {
		super();
	...
	public dsltrans.resource.dsltranstext.IDsltranstextExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		return this.terminal.equals(((DsltranstextExpectedTerminal) o).terminal);
	}
