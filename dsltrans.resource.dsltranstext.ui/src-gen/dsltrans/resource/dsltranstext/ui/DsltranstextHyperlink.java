 ...
 */
public class DsltranstextHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public DsltranstextHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				dsltrans.resource.dsltranstext.mopp.DsltranstextPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
