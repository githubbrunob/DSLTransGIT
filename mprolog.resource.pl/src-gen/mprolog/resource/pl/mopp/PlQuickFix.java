...
public abstract class PlQuickFix implements mprolog.resource.pl.IPlQuickFix {
	...
	public String apply(String currentText) {
		...
		try {
			...
			mprolog.resource.pl.mopp.PlPlugin.logError("Exception while applying quick fix", e);
		}
		return null;
	}
