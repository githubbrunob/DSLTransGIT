...
/**
 * A PlLayoutInformationAdapter is used to store layout information that is found
 ...
 * PlLayoutInformationAdapters are attached to EObjects and aggregate multiple
 ...
 */
public class PlLayoutInformationAdapter implements org.eclipse.emf.common.notify.Adapter {
	 ...
	 * reference.
	 */
	private java.util.List<mprolog.resource.pl.mopp.PlLayoutInformation> layoutInformations = new java.util.ArrayList<mprolog.resource.pl.mopp.PlLayoutInformation>();
	...
	public java.util.List<mprolog.resource.pl.mopp.PlLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(mprolog.resource.pl.mopp.PlLayoutInformation layoutInformation) {
