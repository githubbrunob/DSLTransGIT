 ...
 */
public class SOSEnumerationTerminal extends SOS.resource.SOS.grammar.SOSTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public SOSEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, SOS.resource.SOS.grammar.SOSCardinality cardinality, int mandatoryOccurrencesAfter) {
