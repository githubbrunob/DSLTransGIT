 ...
 */
public class PlNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public PlNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new pl file");
