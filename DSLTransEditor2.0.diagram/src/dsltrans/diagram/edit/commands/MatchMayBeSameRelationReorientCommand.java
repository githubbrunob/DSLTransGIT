 ...
 * @generated
 */
public class MatchMayBeSameRelationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MatchMayBeSameRelationReorientCommand(
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof MatchMayBeSameRelation) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return DsltransBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMatchMayBeSameRelation_4017(container, getLink(),
						getNewSource(), target);
	}
	 ...
	 * @generated
	 */
	protected MatchMayBeSameRelation getLink() {
		return (MatchMayBeSameRelation) getElementToEdit();
	}
