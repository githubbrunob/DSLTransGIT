 ...
 * @generated
 */
public class ClassRef2ItemSemanticEditPolicy extends
		DsltransBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ClassRef2ItemSemanticEditPolicy() {
		super(DsltransElementTypes.ClassRef_3022);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (DsltransVisualIDRegistry.getVisualID(outgoingLink) == ClassRefClassRefEditPart.VISUAL_ID) {
