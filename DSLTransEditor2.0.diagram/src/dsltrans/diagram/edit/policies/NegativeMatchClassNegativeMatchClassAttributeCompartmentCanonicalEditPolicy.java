 ...
 * @generated
 */
public class NegativeMatchClassNegativeMatchClassAttributeCompartmentCanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return DsltransPackage.eINSTANCE.getMatchClass_Attribute();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getNegativeMatchClassNegativeMatchClassAttributeCompartment_7009SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return MatchAttributeEditPart.VISUAL_ID == DsltransVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getNegativeMatchClassNegativeMatchClassAttributeCompartment_7009SemanticChildren((View) getHost()
						.getModel());
