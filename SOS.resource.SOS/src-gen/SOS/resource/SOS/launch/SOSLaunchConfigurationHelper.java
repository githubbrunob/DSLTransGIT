 ...
 * delegates.
 */
public class SOSLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends SOS.resource.SOS.util.AbstractSOSInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, SOS.resource.SOS.util.AbstractSOSInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final SOS.resource.SOS.debug.SOSDebuggableInterpreter<ResultType, ContextType> interpreter = new SOS.resource.SOS.debug.SOSDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		SOS.resource.SOS.debug.SOSDebuggerListener<ResultType, ContextType> debugListener = new SOS.resource.SOS.debug.SOSDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		SOS.resource.SOS.debug.SOSDebugProcess process = new SOS.resource.SOS.debug.SOSDebugProcess(launch);
		launch.addDebugTarget(new SOS.resource.SOS.debug.SOSDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(SOS.resource.SOS.launch.SOSLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return SOS.resource.SOS.util.SOSResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, SOS.resource.SOS.mopp.SOSPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}
