 ...
 * </copyright>
 *
 * $Id: MprologPackageImpl.java,v 1.1 2011/09/27 18:59:53 domingues Exp $
 */
 ...
 * @generated
 */
public class MprologPackageImpl extends EPackageImpl implements MprologPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see mprolog.MprologPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private MprologPackageImpl() {
		super(eNS_URI, MprologFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link MprologPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static MprologPackage init() {
		if (isInited) return (MprologPackage)EPackage.Registry.INSTANCE.getEPackage(MprologPackage.eNS_URI);

		// Obtain or create and register package
		MprologPackageImpl theMprologPackage = (MprologPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof MprologPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new MprologPackageImpl());

		isInited = true;

		// Create package meta-data objects
		theMprologPackage.createPackageContents();

		// Initialize created meta-data
		theMprologPackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theMprologPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(MprologPackage.eNS_URI, theMprologPackage);
		return theMprologPackage;
	}
	 ...
	 * @generated
	 */
	public MprologFactory getMprologFactory() {
		return (MprologFactory)getEFactoryInstance();
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getClause_OwnedHead(), this.getHead(), null, "ownedHead", null, 1, 1, Clause.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
