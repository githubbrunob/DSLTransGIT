...
public class PlMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(mprolog.resource.pl.IPlOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof mprolog.resource.pl.mopp.PlResource) {
					mprolog.resource.pl.mopp.PlResource customResource = (mprolog.resource.pl.mopp.PlResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<mprolog.resource.pl.IPlQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final mprolog.resource.pl.IPlQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									mprolog.resource.pl.ui.PlUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			mprolog.resource.pl.ui.PlUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<mprolog.resource.pl.IPlQuickFix> getQuickFixes(mprolog.resource.pl.IPlTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					mprolog.resource.pl.IPlQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {
