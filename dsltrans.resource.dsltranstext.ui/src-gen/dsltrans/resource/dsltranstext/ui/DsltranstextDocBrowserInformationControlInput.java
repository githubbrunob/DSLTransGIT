 ...
 * olInput</code>.
 */
public class DsltranstextDocBrowserInformationControlInput {
	
	private final DsltranstextDocBrowserInformationControlInput fPrevious;
	private DsltranstextDocBrowserInformationControlInput fNext;
	 ...
	 */
	public DsltranstextDocBrowserInformationControlInput(DsltranstextDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public DsltranstextDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public DsltranstextDocBrowserInformationControlInput getNext() {
		return fNext;
	}
