 ...
 * @generated
 */
public class ConcatConcatLeftTermCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatLeftTermCompartment_7015SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<DsltransNodeDescriptor> childDescriptors = DsltransDiagramUpdater
				.getConcatConcatLeftTermCompartment_7015SemanticChildren((View) getHost()
						.getModel());
